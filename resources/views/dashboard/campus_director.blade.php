...
@section('title','Campus Director Dashboard')
@section('page-title','Campus Director — ' . $user->campus)
...
<div class="container-fluid">
    <div class="row g-3 mb-3">
        <div class="col-md-4">
            <div class="card-stats p-4 rounded">
                ...
                <p class="m-0" style="color:var(--maroon);font-size:18px;font-weight:600">{{ $user->campus }}</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card-stats p-4 rounded">
                <h6 class="text-muted">Campus Logs</h6>
        ...
        <div class="col-md-4">
            <div class="card-stats p-4 rounded">
                ...
                <p class="m-0" style="color:var(--maroon);font-size:18px;font-weight:600">{{ $user->college }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-3 g-3">
        ...
        <div class="col-md-3">
            <a href="{{ route('documents.index') }}" class="btn btn-light" style="width:100%;padding:15px;text-align:left;border:2px solid #eee">
                <div><i class="fas fa-file-alt" style="font-size:24px;color:var(--maroon)"></i></div>
                <div style="margin-top:8px">
                    <strong>All Documents</strong>
                    <p style="margin:0;font-size:12px;color:#999">View documents list</p>
                </div>
            </a>
        </div>
    </div>
